...
public class List2Excel {
    ...
    private ExcelHeaderInfo ehi = null;
    ...
    private List2Excel(String headerCfgPath, String titileName,
        ...
        this.datas = datas;
        ehi = ExcelHeaderInfo.getInstance(headerCfgPath);
    }
     ...
     * @return
     */
    public static List2Excel getInstance(String headerCfgPath, String titileName, String excelFilename, List<Object> datas) {

        instance = new List2Excel(headerCfgPath, titileName, excelFilename, datas);
        return instance;
    }
    ...
    private static String upperCase(String attribute) {
        ...
        if (attribute.charAt(0) == upStr.charAt(0)) {  // 首字符大写
            return attribute;
        } else {
