...
import com.eyric.base.CommonAttributes;
import com.eyric.base.EnumConverter;
import com.eyric.base.Setting;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File shopxxXmlFile = new ClassPathResource(CommonAttributes.VLP_XML_PATH).getFile();
